const _destination = {
    'South Africa' : {
        name: 'South Africa',
        food: ['Biltong & Droewors', 'Braai', 'Cape Malay Curry', 'Malva Pudding', 'Chakalaka & Pap', 'Bunny Chow'], 
    ...
    'Italy': { //!
        name: 'Italy',
        food:  ['Bottarga', 'Lasagna','Ribollita','Ossobuco','Polenta','Gelato'],
    ...
    'Spain': {
        ...
        activity: ['Kitesurfing in Tarifa', 'Paragliding in Madrid', 'Canyoning on the Costa del Sol','Try Rafting in the Sierra de Guara','Surfing in Mundaka','Diving in Ibiza'],
    ...
    'Madeira': {
        ...
        activity: ['do the Levada Walks','do the Funchal Cable Car','do the Panoramic Drives','do the Vereda dos Balcões','go Diving','take Boat Trips'],
    ...
    'Puerto Rico': {
        ...
        activity: [' Surfing and Whale Watching at Rincon','Explore Cañon de Tanamá','Rainforst Zip Line','Camp on Isla de Mona','Kayak and Snorkel in Vieques','Have Coffee in the Mountains'],
    ...
    'Mexico': {
        ...
        attraction: ['Experience Day Of The Dead','Go Diving in Cozumel','Swim in a Cenote','Walk the Malecon in Puerto Vallarta','Carve Up Some Waves','Sample Tequila & Mezcal']
    },
    get generateTrip() {
        ...
        console.log(`In ${year} you should travel to ${selectedDestination}. Whilst you are there you should should try some local food, like the ${selectedFood}. If you are looking for something to do, you should ${selectedActivity} and don't for get to check out The ${selectedAttraction}! ` );
    }
}
